# home-crew-payment-service

Payment capture and refunds for completed bookings.
...
|---|---|
| Port | 8087 |
| Route through the gateway | `/payments/**` |
| Java package | `com.homecrew.paymentservice` |
| Maven artifact | `paymentservice` |
| Image | `mthanuj/homecrew-payment-service:dev` |
| Compose service | `payment-service` |
| Database | `homecrew_payment` |
| Default branch | `dev` |
...
A push to `dev` builds the image and pushes two tags to Docker Hub:
    ...
    mthanuj/homecrew-payment-service:dev
    mthanuj/homecrew-payment-service:sha-<short>
